...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDScreenSpaceReflectionEditor : VolumeComponentWithQualityEditor
    {
        ...
        static public readonly GUIContent k_LodBiasText = EditorGUIUtility.TrTextContent("Lod Bias", "Defines the LOD Bias for sampling all the textures. A higher value will increase peformance and make denoising easier but may reduce visual fidelity.");
        ...
        void RayTracedReflectionGUI()
        {
            ...
            PropertyField(m_LodBias, k_LodBiasText);
